...
$pkendaraan = $chartdonut['peminjamankendaraan'];
$kkendaraan = $chartdonut['pengembaliankendaraan'];
$pelektronik = $chartdonut['peminjamanelektronik'];
$kelektronik = $chartdonut['pengembalianelektronik'];

$nama_bulan = "";
$jumlah = null;
$jumlah2 = null;
foreach ($chartarea as $item) {
    $bln = $item->bulan;
    $nama_bulan .= "'$bln'" . ", ";
    $jum = $item->jumlah;
    $jumlah .= "$jum" . ", ";
